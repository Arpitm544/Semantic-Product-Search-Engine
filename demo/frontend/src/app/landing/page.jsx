...
import PipelineSection, { PipelineBackground } from './components/Pipeline3D';
...
export default function LandingPage() {
  return (
    <div className="landing-layout">
      ...
      {/* 0. Full-page fixed backgrounds (cinematic scroll) */}
      ...
      <div className="foreground-content">
        ...
        <main>
          {/* 1. Hero text and CTAs */}
          <Hero />

          {/* 2. Pipeline stats and text */}
          <PipelineSection />
